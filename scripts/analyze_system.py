...
def cases() -> list[AnalysisCase]:
    ...
    return [
        ...
        AnalysisCase(
            ...
            expected_polish=True,
            risk_note="Education domain: should detect teacher audience and preserve measurable outcome.",  # noqa: E501
        ),
        AnalysisCase(
        ...
        AnalysisCase(
            ...
            expected_polish=True,
            risk_note="Negative framing: system should extract the underlying need, not echo the frustration.",  # noqa: E501
        ),
        AnalysisCase(
        ...
        AnalysisCase(
            ...
            expected_polish=True,
            risk_note="Compound problem: system should not split the brief or pick only one problem.",  # noqa: E501
        ),
    ]
...
def render(payload: dict[str, Any]) -> str:  # noqa: PLR0912
    ...
    lines += [
        ...
        "",
        "| Category | Cases | Completed | Avg Iter | Avg Faithfulness | Avg Quality Δ | Generic Fallback |",  # noqa: E501
        "| --- | ---: | ---: | ---: | ---: | ---: | ---: |",
    ]
...
def _domain_section(results: list[dict[str, Any]]) -> str:
    ...
    for r in results:
        al = r["audience_line"]
        audience = al[:60] + "…" if len(al) > 60 else al
        lines.append(
